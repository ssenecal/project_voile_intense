      ...
      >
        ...
        <div className="flex flex-col h-[384]">
          <div className="m-8">
            ...
            <p className="m-2 text-[18px]">
              Explore the journey behind the creation of our new luxurious
              elixir, crafted from a curated selection of rare seeds sourced
              from a pristine desert region.
            </p>
          </div>
          <div className="flex flex-col">
            <Link
              className="text-center border-1 border-[#DBDBD1] uppercase mx-8 my-2 p-2 border-color-button"
              href="/"
            >
              Discover the story
            </Link>
